...
import * as modules from './src/mappings';
...
import * as map from './src/mappings'
import { getOrCreateAccount } from './src/mappings/util/entities'
import { CommonContext } from './src/mappings/types/contexts'
import { populateBlock } from './src/populateBlock'
import { updateClaimDetails } from './src/mappings/claims/common'
import { syncAllCollections } from './src/jobs/collection-stats'
import { metadataQueue } from './src/jobs/process-metadata'
import { getTankDataFromCall } from './src/mappings/fuelTanks/common'
